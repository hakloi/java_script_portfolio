...
function draw(){
    ...
    if (keyIsPressed == true){
        if (key == "d" || key == "в" || keyCode === RIGHT_ARROW){
            isRight = true;
            standRight(CharX, CharY);
            CharX = CharX +3;
        }
        if (key == "a" || key == "ф" || keyCode === LEFT_ARROW){
            isLeft = true;
        ...
        if (key == "w" || key == "ц" || keyCode === UP_ARROW || keyCode === 32){
...
function keyPressed(){
    ...
    else if (key == "d" || key == "в" || keyCode === RIGHT_ARROW) {
        isRight = true;
    }
    if (key == "w" || key == "ц" || keyCode === UP_ARROW) {
//        jumpFront(CharX, CharY);
            if(key == "d" || key == "в" || keyCode === RIGHT_ARROW){
                console.log();
                jumpRight(CharX,CharY);
